#pragma checksum "D:\NetProjects\Mvc_Apteka\Views\ProductsSearch\Search.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5dc43a5f0939480a9c59f0d19d8ebc8128d7fe76"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5dc43a5f0939480a9c59f0d19d8ebc8128d7fe76", @"/Views/ProductsSearch/Search.cshtml")]
       ...
       ");
         ...
         ");
           ...
           ");
            ...
            $onsearch( message ){
                ...
                if( typeof(message.value)=='undefined' )
                    throw new Error('Аргумент message.value фукнции oninput(..) ");
            WriteLiteral(@"не определён');                
                console.log(`$oninput(${JSON.stringify(message)})`);
                switch(message.name){
                    case 'searchInput':
                        ...
                        $http().$get(location,r).then(
                            (state)=>{
                                ...
                                if( !state.status )
                                    throw new Error('Обработчик запроса '+location+' получил не дейтсвительное значение в аргументе state.status');    
                                if( !state.headers )
                                    throw new Error('Обработчи");
            WriteLiteral(@"к запроса '+location+' получил не дейтсвительное значение в аргументе state.headers');    
                                console.log(state);
                                switch(state.status)
                                {
                                    case 200:
        ...
        function $table( properties ){
            ...
            for(let i=0; i<names.length; i++){                
                html += ");
            WriteLiteral(@"'<tr><td>'+names[i]+'</td><td>'+properties[names[i]]+'</td></tr>';
            }
            html += '</table>';
            return html;
        }
        function $searchFilters(){
            ...
            const priceRangeCtrl = ctrl.priceRangeCtrl = $inputRange('Цена',     'number',");
            WriteLiteral(@" 'price', 0, 1000000, 'цена', function validate(){} );                
